...
This demonstration shows the installation of the open-source help desk ticketing system osTicket.<br />
...
- Created PHP file in file explorer
- Installed Microsoft Visual C++
- Installed HeidiSQL
- Installed MySQL Server
- Registered new PHP version
- Installed and created osTicket account

<h2>Installation Steps</h2>

<p>
<img width="618" height="559" alt="image" src="https://github.com/user-attachments/assets/dafab104-266b-47fd-a9ab-1b40ba535def" />
</p>
<p>
To turn on CGI, go to the Control Panel. Open programs, check internet information services, drop down world wide web services, drop down application development features, and check CGI. Press ok. 
</p>
<br />
...
<p>
<img width="656" height="573" alt="image" src="https://github.com/user-attachments/assets/8b66ed36-bb03-4da4-b34c-b16c798bd5b9" />
...
<p>
<img width="653" height="686" alt="image" src="https://github.com/user-attachments/assets/bacbd34f-8735-4da5-8301-91d9993b292b" />
</p>
<p>
Opened File Explorer, go to the C drive. Right-click, go to New, click New Folder, and name the new folder PHP. Extract PHP 7.3 into the new PHP folder on the C drive.
</p>
<br />
